...
int EPOS2::set_position_setting(int32_t p) {
	int t;
...
int32_t EPOS2::get_position_setting() {
	int t;
...
int EPOS2::set_velocity_setting(int32_t v) {
	int t;
...
int32_t EPOS2::get_velocity_setting() {
	int t;
...
uint16_t EPOS2::get_misc_config() {
	int t;
...
int EPOS2::set_profile_target_position(int32_t p) {
	int t;
...
int32_t EPOS2::get_profile_target_position() {
	int t;
...
int EPOS2::set_profile_target_velocity(int32_t v) {
	int t;
...
int32_t EPOS2::get_profile_target_velocity() {
	int t;
...
int EPOS2::set_profile_quickstop_deceleration(uint32_t d) {
	int t;
...
uint32_t EPOS2::get_profile_quickstop_deceleration() {
	int t;
...
int EPOS2::set_profile_motion(MOTION_PROFILES ty) {
	int t;
...
uint16_t EPOS2::get_profile_motion() {
	int t;
...
uint32_t EPOS2::get_max_ipm_buffer() {
	int t;
...
uint32_t EPOS2::get_actual_ipm_buffer() {
	int t;
...
uint16_t EPOS2::get_ipm_buffer_status() {
	int t;
...
int EPOS2::set_ipm_buffer(uint8_t v) { // Clear Buffer
	int t;
...
int EPOS2::set_position_window(uint32_t w) {
	int t;
	t = send(get_frame(WRITE_OPCODE, 3, 0x6068, 0x00, (uint16_t) w, (uint16_t) w>>16));
	if(t) return -1;
	return(0);
}
...
int EPOS2::add_to_ipm_buffer(uint32_t p, uint32_t v, uint8_t ti) {
	int t;
