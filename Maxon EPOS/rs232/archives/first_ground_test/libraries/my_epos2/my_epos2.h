...
public:
	...
	int send_data(epos2_frame f);
	int send_crc(epos2_frame f);
	...
	uint32_t get_gear_ratio_numerator(); // 0x2230 - 0x01
	int set_gear_ratio_numerator(uint32_t gn);
	uint16_t get_gear_ratio_denominator(); // 0x2230 - 0x02
	int set_gear_ratio_denominator(uint16_t gd);
	...
	// Nice functions
	void kill();
	void rotation(EPOS2_MOTOR_ROTATIONS d);
	void goto_position(int32_t p, uint32_t v, uint32_t a); // Position Mode
	void goto_position(int32_t p, uint32_t v);
	void goto_position(int32_t p);
	void position(int32_t p, uint32_t v, uint32_t a, uint32_t d, uint32_t qd, MOTION_PROFILES m); // Profile Position Mode
	void position(int32_t p, uint32_t v, uint32_t a, uint32_t d, MOTION_PROFILES m);
	void position(int32_t p, uint32_t v, uint32_t a, MOTION_PROFILES m);
	void position(int32_t p, uint32_t v, MOTION_PROFILES m);
	void position(int32_t p, MOTION_PROFILES m);
	void position(POSITION_TYPES pty);
	void position();
	void position_stop();
	void position(int32_t p, uint32_t v, uint32_t a, uint32_t d, uint32_t qd);
	void position(int32_t p, uint32_t v, uint32_t a, uint32_t d);
	void position(int32_t p, uint32_t v, uint32_t a);
	void position(int32_t p, uint32_t v);
	void position(int32_t p);
	void run_with_velocity(int32_t v, uint32_t a); // Velocity mode
	void run_with_velocity(int32_t v);
	void velocity(int32_t v, uint32_t a, uint32_t d, uint32_t qd, MOTION_PROFILES m); // Profile Velocity Mode
	void velocity(int32_t v, uint32_t a, uint32_t d, MOTION_PROFILES m);
	void velocity(int32_t v, uint32_t a, MOTION_PROFILES m);
	void velocity(int32_t v, MOTION_PROFILES m);
	void velocity();
	void velocity_stop();
	void velocity(int32_t v, uint32_t a, uint32_t d, uint32_t qd);
	void velocity(int32_t v, uint32_t a, uint32_t d);
	void velocity(int32_t v, uint32_t a);
	void velocity(int32_t v);
};
