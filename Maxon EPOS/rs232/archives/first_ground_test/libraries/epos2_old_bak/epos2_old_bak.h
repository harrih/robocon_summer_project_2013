...
public:
	...
	uint16_t get_ipm_buffer_underflow_warning();
	uint16_t get_ipm_buffer_overflow_warning();
	...
	int add_ipm_buffer_underflow_warning(uint16_t l);
	int add_ipm_buffer_overflow_warning(uint16_t l);
